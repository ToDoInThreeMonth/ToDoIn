...
//        placeholder = "Введите имя"
        attributedPlaceholder = NSAttributedString(string: "Введите имя", attributes: [NSAttributedString.Key.foregroundColor: UIColor.lightTextColor])
        returnKeyType = .done
    ...
    private func setupRightView() {
        ...
        rightView.tintColor = .darkTextColor
    ...
    private func setupLeftView() {
        ...
        vStrokeView.backgroundColor = .darkTextColor

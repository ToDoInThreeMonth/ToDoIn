...
extension UIColor {
    static let darkAccentColor = UIColor(red: 0.953, green: 0.969, blue: 0.98, alpha: 1)
    static let lightAccentColor = UIColor(red: 0.953, green: 0.969, blue: 0.98, alpha: 0.5)
